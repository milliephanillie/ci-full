...
class RapidTitleTags {
     ...
     * @return string
     */
    public function lisfinity_meta_desc() {
        if (strpos($_SERVER['REQUEST_URI'], '/ad-category/') !== false) {
            $meta_dec = "Your project requires top-quality concrete equipment, and we've got it all. From mixing to demolition, browse our full range to find the tools that will keep your site running smoothly.";
        ...
        if(strpos($_SERVER['QUERY_STRING'], 'concrete-batching-equipment') !== false) {
            $meta_dec = "Enhance your concrete production with top-notch batching equipment. Find your ideal mixers and plants for precise mixture formulations. Get the best for your build, shop now!";
        ...
        if(strpos($_SERVER['QUERY_STRING'], 'concrete-cutting-and-demolition-equipment') !== false) {
            $meta_dec = "Maximize efficiency with advanced concrete pumping equipment. Tailor your search for trailer to boom pumps to meet your project's needs. Shop for reliable pumping solutions now!";
        ...
        if(strpos($_SERVER['QUERY_STRING'], 'general-construction-equipment') !== false) {
            $meta_dec = "Equip your project with our comprehensive range of general construction equipment. From power tools to heavy machinery, find all your essential building tools in one place!";
        ...
        if(strpos($_SERVER['QUERY_STRING'], 'other-concrete-equipment') !== false) {
            $meta_dec = "Explore our diverse range of concrete equipment for those niche tasks. Find the perfect addition to your toolkit, from vibrators to repair kits, to ensure a job well done.";
        ...
        $meta_description_to_use = ($random_number === 1) ? $meta_dec : $meta_dec_alt;

        return $meta_description_to_use;
    }
}