...
<head>
    ...
    <![endif]-->
    <title>New Message: ConcreteIron</title>
    <style>
            ...
            <tr>
                <td style="width: 552px; max-width: 100%">
                    ...
                    <table style="width: 100%;" cellpadding="0" cellspacing="0" role="none">
                        <tr>
                            <!-- #E4AD52 -->
                            <td class="sm-text-3xl" style="background-color: #013220; padding: 40px; text-align: center; font-size: 24px; font-weight: 700">
                                <p style="color: white;"><?php echo $name; ?>, You have a new message.</p>
                            </td>
                        </tr>
                        <tr role="separator">
